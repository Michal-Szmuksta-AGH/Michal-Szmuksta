...
def process_email(email_contents: str) -> List[int]:
    ...
    # DONEFIXME: Load the vocabulary.
    vocabulary_dict = get_vocabulary_dict()

    # DONEFIXME: Initialize the return value.
    word_indices = []
    ...
    # DONEFIXME: Convert email content to lower case.
